                     ...
                     <div class="floated-chat-w">
                        <div class="floated-chat-i">
                           ...
                           <div class="chat-controls">
                              ...
                              <div class="chat-extra"><a href="index.html#"><span class="extra-tooltip">Attach Document</span><i class="os-icon os-icon-documents-07"></i></a><a href="index.html#"><span class="extra-tooltip">Insert Photo</span><i class="os-icon os-icon-others-29"></i></a><a href="index.html#"><span class="extra-tooltip">Upload Video</span><i class="os-icon os-icon-ui-51"></i></a></div>
                           </div>
                        </div>
                     </div>