...
mysql_select_db($database_hemera, $hemera);
$query_rproc = "SELECT ds_customer.nm_depan, ds_customer.nm_belakang, ds_customer.alamat, ds_customer.propinsi, ds_customer.kota, ds_customer.kd_pos, ds_customer.no_hp, ds_customer.email, ds_customer.catatan, ds_customer.tgl_in, ds_customer.jam_in, ds_customer.kd_order, trx_ds.hrg_tot, trx_ds.hrg_shipping, trx_ds.hrg_grand, trx_ds.sts_order, trx_ds.sts_bayar, trx_ds.sts_proses, trx_ds.sts_terima, trx_ds.kd_ds FROM ds_customer JOIN trx_ds ON ds_customer.kd_order = trx_ds.kd_order WHERE trx_ds.kd_ds='$_SESSION[HEM_kd_ds]'  AND trx_ds.sts_order='1' AND trx_ds.sts_bayar='1' AND trx_ds.sts_proses='1'  AND trx_ds.sts_kirim='0' ORDER BY trx_ds.id_ DESC";
...
mysql_select_db($database_hemera, $hemera);
$query_rship = "SELECT ds_customer.nm_depan, ds_customer.nm_belakang, ds_customer.alamat, ds_customer.propinsi, ds_customer.kota, ds_customer.kd_pos, ds_customer.no_hp, ds_customer.email, ds_customer.catatan, ds_customer.tgl_in, ds_customer.jam_in, ds_customer.kd_order, trx_ds.hrg_tot, trx_ds.hrg_shipping, trx_ds.hrg_grand, trx_ds.sts_order, trx_ds.sts_bayar, trx_ds.sts_proses, trx_ds.sts_terima, trx_ds.kd_ds FROM ds_customer JOIN trx_ds ON ds_customer.kd_order = trx_ds.kd_order WHERE trx_ds.kd_ds='$_SESSION[HEM_kd_ds]'  AND trx_ds.sts_order='1' AND trx_ds.sts_bayar='1' AND trx_ds.sts_proses='1'  AND trx_ds.sts_kirim='1' ORDER BY trx_ds.id_ DESC";
                              ...
                              <div class="element-content">
                                 <div class="row">
                                    <div class="col-sm-4 col-xxxl-3">
                                       <a class="element-box el-tablo" href="index.php?com=new_order_ds&layout=full">
                                    ...
                                    <div class="col-sm-4 col-xxxl-3">
                                       <a class="element-box el-tablo" href="index.php?com=proses_order_ds&layout=full">
                                    ...
                                    <div class="col-sm-4 col-xxxl-3">
                                       <a class="element-box el-tablo" href="index.php?com=shipped_order_ds&layout=full">
