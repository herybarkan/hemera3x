                           ...
                           <div class="element-wrapper">
                              ...
                              <div class="element-box-tp">
                                 <div class="controls-above-table">
                                    <div class="row">
                                       <div class="col-sm-6"><a class="btn btn-sm btn-secondary" href="index.html#">Download CSV</a><a class="btn btn-sm btn-secondary" href="index.html#">Archive</a><a class="btn btn-sm btn-danger" href="index.html#">Delete</a></div>
                                       <div class="col-sm-6">
                                    ...
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td class="row-actions"><a href="index.html#"><i class="os-icon os-icon-ui-49"></i></a><a href="index.html#"><i class="os-icon os-icon-grid-10"></i></a><a class="danger" href="index.html#"><i class="os-icon os-icon-ui-15"></i></a></td>
                                          </tr>
                                          <tr>
                                             <td class="text-center"><input class="form-control" type="checkbox"></td>
                                             <td>Mike Astone</td>
