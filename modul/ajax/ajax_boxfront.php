...
$query_rdata = "SELECT * FROM list_box_front WHERE id='$_GET[get_bf]' AND aktif='1'";
...
<div class="row">
  <?php do { ?>
    <div class="col-6" style="padding:10px;">
      <img src="https://hemerapartner.com/admin/img/template/box_front/<?php echo $row_rdata['nm_foto']; ?>" style="width:100%;"> 
      <br>
