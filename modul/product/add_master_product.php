...
<div class="element-wrapper">
                              ...
                              <div class="element-box">
                                 <form action="modul/product/in_master_product.php" method="post" enctype="multipart/form-data" id="fin">
...
do {  
?>
                                        <option value="<?php echo $row_rsup['kd_suplier']?>"><?php echo $row_rsup['nm_suplier']?></option>
                                        <?php
