...
$xsds=$_POST['ssup'];
	if ($xsds!="") {$qsds=" AND product_master.kd_suplier='$xsds'";}
elseif ($xsds=="") {$qsds="";}
...
<form class="form-inline justify-content-sm-end" id="fsearch" name="fsearch" method="POST" action="index.php?com=list_sup_trx&layout=full">
...
<a href="index.php?com=list_sup_product_adm&layout=full"><input name="bt_reload" type="button" class="btn btn-success" style="margin-left:10px;" value="Reload"/></a>
   ...
   <h6 class="element-header">List of All Transaction
   </h6>
</div>
         ...
         <table width="100%"  class="table table-padded wrap ">
            ...
            <tbody>
               ...
               <tr>
                   ...
                   <?php 
					if (
					$row_rorder['sts_bayar']="0" && 
					$row_rorder['sts_proses']=="0" && 
					$row_rorder['sts_kirim']=="0"
					) 
						{echo "New Order";}
					elseif (
					$row_rorder['sts_bayar']="1" && 
					$row_rorder['sts_proses']=="0" && 
					$row_rorder['sts_kirim']=="0"
					) 
						{echo "Sudah Bayar";}
					...
					$row_rorder['sts_bayar']="1" && 
					$row_rorder['sts_proses']=="1" && 
					$row_rorder['sts_kirim']=="1"
					) 
						{echo "Sudah Dikirim";}
				   //echo $row_rorder['sts_bayar']; ?>
                   <?php //echo $row_rorder['sts_proses']; ?>
                   <?php //echo $row_rorder['sts_kirim']; ?>
                   <?php //echo $row_rorder['sts_terima']; ?>
                   </td>
                   <td align="center"><span class="onboarding-media"><?php echo $row_rorder['kd_suplier']; ?></span></td>
                   <td>
