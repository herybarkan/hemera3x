...
?>
                                 ...
                                 <h5 class="form-header">LIST NEW ORDER <span class="float-right"><?php echo $row_rnew['kd_order']; ?></span></h5>
                                 <!--<button type="button" class="close" onclick="$('.bdx-example-modal-lg').modal('hide'); $('.bd-example-modal-lg').modal('dispose');" aria-label="Close">close</button>-->
