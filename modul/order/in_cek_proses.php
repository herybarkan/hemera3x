...
tgl_proses='$tglin',
proses_by='$_SESSION[HEM_kd_user]',
sts_proses='$_POST[sapproval]',
alasan_proses='$_POST[reason]'
...
$totalRows_rdsem = mysql_num_rows($rdsem);
	...
	if ($_POST['sapproval']=="1") {$sts_konf=" Sedang Di Proses";}
            ...
            <tr>
               <td style="padding:8px 20px 16px;background-color:#ffffff">
                  <h3 style="margin:0;font-family:Helvetica,Arial,sans-serif;font-weight:bold;font-size:20px;line-height:26px">
                     Konfirmasi Order</h3>
                  <p style="margin:4px 0 0;font-family:Helvetica,Arial,sans-serif;font-size:14px;line-height:21px">Transaksi Pembelian baru '.$sts_konf.' dengan data detail sebagai berikut:</p>
               </td>
            </tr>
            <tr>
...
header("Location: ../../index.php?com=payed_order_adm&layout=full");
?>