...
<form class="form-inline justify-content-sm-end" id="fsearch" name="fsearch" method="POST" action="index.php?com=payed_order_adm&layout=full">
...
<a href="index.php?com=payed_order_adm&layout=full"><input name="bt_reload" type="button" class="btn btn-success" style="margin-left:10px;" value="Reload"/></a>
</form>
</div>
   <h6 class="element-header">List of Paid Order
...
$totalRows_rqty = mysql_num_rows($rqty);
                   ...
                   <td >
                    ...
                    <br>
                     <a href="javascript:void(0);" data-href="modul/order/cek_proses_order.php?kd_order=<?php echo $row_rorder['kd_order']; ?>" class="btn btn-warning btn-sm text-red openPopup" style="width:100px;">Proses</a>
