...
<form class="form-inline justify-content-sm-end" id="fsearch" name="fsearch" method="POST" action="index.php?com=new_order_adm&layout=full">
...
<a href="index.php?com=new_order_adm&layout=full"><input name="bt_reload" type="button" class="btn btn-success" style="margin-left:10px;" value="Reload"/></a>
</form>
</div>
...
$totalRows_rqty = mysql_num_rows($rqty);
                   ...
                   <td >
                    ...
                    <br>
                     <a href="javascript:void(0);" data-href="modul/order/cek_transfer_order.php?kd_order=<?php echo $row_rorder['kd_order']; ?>" class="btn btn-warning btn-sm text-red openPopup" style="width:100px;">Check</a>
