...
tgl_cbt='$tglin',
ver_bt_by='$_SESSION[HEM_kd_user]',
sts_bayar='$_POST[sapproval]',
alasan_bayar='$_POST[reason]'
...
$totalRows_rdsem = mysql_num_rows($rdsem);
	...
	if ($_POST['sapproval']=="1") {$sts_konf=" Ter Verifikasi";}
...
header("Location: ../../index.php?com=new_order_adm&layout=full");
?>