...
WHERE product_master.kd_suplier='$row_rcek_sup[kd_suplier]' 
$qsds $qtgl $qcustomer 
GROUP BY
trx_ds.kd_order
ORDER BY
         ...
         <table width="100%"  class="table table-padded wrap ">
            ...
            <tbody>
               ...
               <tr>
                   ...
                   <?php 
					if (
					$row_rorder['sts_order']=="1" && 
					$row_rorder['sts_bayar']=="0" && 
					$row_rorder['sts_proses']=="0" && 
					$row_rorder['sts_kirim']=="0"
					) 
						{echo "<img src=\"img/icon_new.png\" height=\"30\"> ";}
					elseif (
					$row_rorder['sts_bayar']=="1" && 
					$row_rorder['sts_proses']=="0" && 
					$row_rorder['sts_kirim']=="0"
					) 
						{echo "<img src=\"img/icon_paid.png\" height=\"30\"> ";}
					elseif (
					$row_rorder['sts_bayar']=="1" && 
					$row_rorder['sts_proses']=="1" && 
					$row_rorder['sts_kirim']=="0"
					) 
						{echo "<img src=\"img/icon_packaging.png\" height=\"30\"> ";}
					elseif (
					$row_rorder['sts_bayar']=="1" && 
					$row_rorder['sts_proses']=="1" && 
					$row_rorder['sts_kirim']=="1"
					) 
						{echo "<img src=\"img/icon_shipping.png\" height=\"30\"> ";}
