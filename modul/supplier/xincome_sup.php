...
elseif ($xsds=="") {$qsds="";}
	...
	if ($xtgl!="") {$qtgl=" AND tgl_tarik='$xtgl'";}
elseif ($xtgl=="") {$qtgl="";}
...
mysql_select_db($database_hemera, $hemera);
$query_rorder = "SELECT * FROM income_supplier WHERE kd_supplier='$row_rcek_sup[kd_suplier]' AND sts_wd='0' $qtgl ORDER BY id_ DESC";
...
//$xsaldo=$row_rtinc['tot_income']-$row_rtdw['tot_wd'];
$xpendapatan=$row_rtinc['tot_income']+$row_rtdw['tot_wd'];
?>
...
<form class="form-inline justify-content-sm-end" id="fsearch" name="fsearch" method="POST" action="index.php?com=xincome_sup&layout=full">
...
<a href="index.php?com=xincome_sup&layout=full"><input name="bt_reload" type="button" class="btn btn-rounded btn-outline-danger" style="margin-left:10px;" value="Reload"/></a>
</form>
</div>
   <h6 class="element-header">List of Income<!--<a href="?com=add_master_product&layout=full" >
   ...
   <div class="element-box-tp">
      <div class="table-responsive">
         ...
         <table width="100%"  class="table table-padded wrap ">
            <thead>
               <tr>
                  <th width="3%"><input name="cball" type="checkbox"  id="cball"></th>
                  <th width="18%"> Income code</th>
                  <th width="23%">Date</th>
                  <th width="18%">Time</th>
            ...
            <?php $jml=0; ?>
               ...
               <tr>
                   ...
                   <a href="javascript:void(0);" data-href="modul/order/detail_orderx.php?kd_income=<?php echo $row_rorder['kd_income']; ?>" class="openPopup" style="width:100px;">
				   <?php echo $row_rorder['kd_income']; ?>
                   </a>
                   
                   </td>
                   <td><span class="onboarding-media"><?php echo $row_rorder['tgl_tarik']; ?></span></td>
                   <td><span class="onboarding-media"><?php echo $row_rorder['jam_tarik']; ?></span></td>
                   <td><strong>IDR. <?php echo number_format($row_rorder['nominal'],0,",","."); ?></strong></td>
                </tr>
               <?php $jml+=$row_rorder['nominal']; ?>
               ...
               <tr>
                 ...
                 <td>&nbsp;</td>
                 <td>&nbsp;</td>
                 <td><span style="font-weight:700; color:#F00;">IDR. <?php echo number_format($jml,0,",","."); ?></span></td>
               </tr>
            </tbody>
         </table>
         <div class="row">
         <div class="col-10"></div>
         <div class="col-2"><input name="bt_reload" type="submit" class="btn btn-danger float-right btn-rounded" style="margin-left:10px;" value="MOVE TO ACCOUNT"/></div>
         </div>
         </form>
