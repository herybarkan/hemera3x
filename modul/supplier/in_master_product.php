...
$xkd_suplier = mysql_real_escape_string($_POST['kd_supplier']);
...
$query_rinsup = "INSERT INTO product_master (
kd_product,
kd_suplier,
kd_warna,
kd_size,
...
header("Location: ../../index.php?com=add_sup_product&layout=full");
?>