...
trx_ds.sts_bayar='1' AND trx_ds.sts_proses='0' AND product_master.kd_suplier='$row_rcek_sup[kd_suplier]' 
$qsds $qtgl $qcustomer 
GROUP BY
trx_ds.kd_order
ORDER BY
...
<a href="index.php?com=payed_order_adm&layout=full"><input name="bt_reload" type="button" class="btn btn-rounded btn-outline-danger" style="margin-left:10px;" value="Reload"/></a>
</form>
</div>
            ...
            <tbody>
               ...
               <tr>
                   ...
                   <a href="javascript:void(0);" data-href="modul/order/detail_order.php?kd_order=<?php echo $row_rorder['kd_order']; ?>" class="btn btn-success btn-sm text-white openPopup" style="width:100px;">Detail</a>
                    <br>
                     <a href="javascript:void(0);" data-href="modul/supplier/cek_proses_order_sup.php?kd_order=<?php echo $row_rorder['kd_order']; ?>" class="btn btn-warning btn-sm text-red openPopup" style="width:100px;">Proses</a>
                   </td>
                   <td>
