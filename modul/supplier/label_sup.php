...
<table width="409" height="539"  border="1"  background="" bordercolor="#131313">
 ...
 echo '<img src="'.$tempdir.'qrwithlogo.png'.'" width="297"  align="middle"/>';
 //echo '<br><a href="https://www.maribelajarcoding.com">maribelajarcoding.com</a><div>';
 ?>
 
			<img src="https://hemerapartner.com/admin/img/template/logo/<?php echo $row_rds['logo']; ?>" alt="" width="90" align="middle"/> 
