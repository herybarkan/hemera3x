...
FROM ds_customer  
JOIN trx_ds ON ds_customer.kd_order = trx_ds.kd_order   
JOIN trx_ds_detail ON trx_ds_detail.kd_order = trx_ds.kd_order   
JOIN product_master ON product_master.kd_product = trx_ds_detail.kd_prod   
JOIN product_color ON product_color.kd_color = product_master.kd_warna   
JOIN product_size ON product_size.kd_size = product_master.kd_size  
WHERE trx_ds_detail.kd_order='$_GET[kd_order]'";
...
<div class="onboarding-side-by-side">
                ...
                <img alt="" src="https://<?php echo $row_rds['nm_domain']; ?>/foto/<?php echo $row_rtrf['bukti_trf']; ?>" width="280px">
                <!--<img alt="" src="https://hemerapartner.com/<?php //echo $row_rds['nm_domain']; ?>/foto/<?php //echo $row_rtrf['bukti_trf']; ?>" width="280px">-->
...
<div class="element-wrapper">
                              ...
                              <div class="element-box">
                                 <form action="modul/supplier/in_cek_bt_sup.php" method="post" id="fin">
                                    ...
                                    <div class="col-sm-6">
                                      ...
                                      <div class="col-sm-6">
                                      <div class="form-group">
                                        <label for="file_foto"> Email Dropshipper</label>
                                        <span class="float-right"><?php echo $row_rds['email_toko']; ?></span>
