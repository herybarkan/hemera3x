...
WHERE trx_ds.sts_order='1' AND trx_ds.sts_bayar='9' AND product_master.kd_suplier='$row_rcek_sup[kd_suplier]'
$qsds $qtgl $qcustomer 
GROUP BY
trx_ds.kd_order
ORDER BY
...
<a href="index.php?com=reject_order_adm&layout=full"><input name="bt_reload" type="button" class="btn btn-rounded btn-outline-danger" style="margin-left:10px;" value="Reload"/></a>
</form>
</div>
