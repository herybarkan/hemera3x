...
$query_rds = "SELECT * FROM ds_banner_category WHERE kd_dropshipper='$_SESSION[HEM_kd_ds]'";
...
<div class="row pt-4">
   <div class="col-sm-12">
      <div class="element-wrapper">
         ...
         <h6 class="element-header">Box Front</h6>
...
<div class="element-box-tp">
                                      <?php do { ?>
                                       <div class="post-box" style="height:300px;">
                                          <div class="post-media" style="background-image: url('https://hemerapartner.com/admin/img/template/box_front/<?php echo $row_rds['foto']; ?>')"></div>
                                          <div class="post-content">
                                             ...
                                             <div class="post-foot">
                                                ...
                                                <a class="btn btn-outline-primary" href="modul/template/edit_box_front.php?id_bf=<?php echo $row_rds['id_']; ?>"  data-target=".bd-example-modal-lg" data-toggle="modal"><span>Edit</span><i class="os-icon os-icon-arrow-2-right"></i></a>
                                             </div>
                                          </div>
                                       </div>
