...
define("DESTINATION_FOLDER", "../../img/template/box_front/");
...
$query_rslider = "UPDATE ds_banner_category SET
foto= '$_name_',
title='$_POST[title]',
link='$_POST[title]'
...
header("Location: ../../index.php?com=box_front");
