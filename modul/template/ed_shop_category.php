...
define("DESTINATION_FOLDER", "../../img/template/shop_category/");
...
$query_rslider = "UPDATE ds_shop_category SET
...
mysql_select_db($database_hemera, $hemera);
$query_rslidex = "UPDATE ds_shop_category SET
nama= '$nama',
link= '$link'
WHERE id_='$_POST[hf_id]'";
$rslidex = mysql_query($query_rslidex, $hemera) or die(mysql_error());

header("Location: ../../index.php?com=shop_category");
