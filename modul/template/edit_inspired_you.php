...
$query_rbf = "SELECT * FROM ds_inspired_you WHERE id_='$_GET[id_iy]'";
$rbf = mysql_query($query_rbf, $hemera) or die(mysql_error());
$row_rbf = mysql_fetch_assoc($rbf);
$totalRows_rbf = mysql_num_rows($rbf);
?>
<img src="https://hemerapartner.com/admin/img/template/inspired_you/<?php echo $row_rbf['foto']; ?>" style="height:218px;;" />
<br><br>
<div class="col-sm-12">
      <div class="element-wrapper">
         
         <h6 class="element-header">Update Image Inspired You</h6>
         <div class="element-content">
   
<form action="modul/template/ed_inspired_you.php" method="POST" enctype="multipart/form-data" id="fup">
<div class="row">
                                       ...
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                             ...
                                             <br>
                                             <a class="btn btn-grey" href="#" onclick="show_iy();"><i class="os-icon os-icon-plus-circle"></i><span>Browse File</span></a>
                                          </div>
                                       </div>
