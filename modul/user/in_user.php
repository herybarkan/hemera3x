...
$sgrup = $_POST['sgrup'];
$sel_mem = $_POST['sel_mem'];
/*echo "id supplier: ".$sel_mem."<br>";
echo "jenis grup: ".$sgrup."<br>";*/
...
{
mysql_select_db($database_hemera, $hemera);
$query_addsupp = "UPDATE suplier SET kd_user='$kd_reg' WHERE id_='$sel_mem'";
$addsupp = mysql_query($query_addsupp, $hemera) or die(mysql_error());
}

header("Location: ../../index.php?com=list_of_user&layout=full");
?>