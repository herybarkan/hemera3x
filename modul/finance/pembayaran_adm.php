...
$query_rpay = "SELECT  dropshiper.nm_domain,  dropshiper.nm_toko,  finance_trf_ds.id_, finance_trf_ds.tgl_payment,  SUM(finance_trf_ds.nominal) AS nominal  FROM dropshiper  JOIN finance_trf_ds ON dropshiper.kd_dropshiper = finance_trf_ds.kd_ds GROUP BY dropshiper.nm_domain";
         ...
         <table width="100%"  class="table table-padded wrap ">
            ...
            <?php $x=1; $xqty=0; $xhp=0; $xdp=0; $sp=0; $zmargin=0;?>
               ...
               <tr>
                 ...
                 <td><?php echo $row_rpay['nm_toko']; ?></td>
                   <td align="right">IDR <?php echo number_format($row_rpay['nominal'],0,",","."); ?></td>
                   <td >
                   
                   <a href="javascript:void(0);" data-href="modul/finance/detail_profit_payment_adm.php?id_=<?php echo $row_rpay['id_']; ?>" class="btn btn-success btn-sm text-white openPopup" style="width:100px;">Detail</a>
