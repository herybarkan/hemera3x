...
<?php
   ...
   $query_rpay = "SELECT  * FROM upload_pembayaran WHERE id_='$_GET[id_]'";
   $rpay = mysql_query($query_rpay, $hemera) or die(mysql_error());
   $row_rpay = mysql_fetch_assoc($rpay);
   $totalRows_rpay = mysql_num_rows($rpay);
   
   mysql_select_db($database_hemera, $hemera);
   $query_rrek_hem = "SELECT * FROM rekening_hemera WHERE id_='$row_rpay[ke_rek]'";
...
<div class="element-wrapper">
   <h6 class="element-header">Detail Statement</h6>
         ...
         <div class="col-sm-4">
            ...
            <div class="col-sm-12">
               <div class="form-group">
                  <label for="file_foto">Bank Pengirim</label>
                  <br>
                  <?php echo $row_rpay['bank']; ?>
               </div>
            </div>
         ...
         <div class="col-sm-4">
            ...
            <div class="col-sm-12">
               <div class="form-group"><label for="file_foto">Bukti Transfer</label>
                  ...
                  <img src="https://hemerapartner.com/admin/foto/pembayaran/<?php echo $row_rpay['bukti_transfer']; ?>" width="300" /> 
               </div>
            </div>
