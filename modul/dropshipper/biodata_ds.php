...
mysql_select_db($database_hemera, $hemera);
$query_rds = "SELECT * FROM dropshiper WHERE kd_user='$_SESSION[HEM_kd_user]'";
...
<div class="content-box">
                     <div class="row">
                        <div class="col-sm-5">
                           <div class="user-profile compact">
                              ...
                              <div class="up-controls">
                                 <div class="row">
                                    ...
                                    <i class="os-icon os-icon-image"></i><span>Upload Photo</span></a></div>
                                 </div>
                              </div>
                           ...
                           <div class="element-wrapper">
                              <div class="element-box">
                                 ...
                                 <form action="modul/dropshipper/ed_user_ds.php" method="POST" name="fuser">
                                 <div class="row">
                                          <div class="col-sm-6">
                        ...
                        <div class="col-sm-7">
                           <div class="element-wrapper">
                              <div class="element-box">
                                 <form method="post" id="formValidate" action="modul/dropshipper/ed_biodata_ds.php">
                                    ...
                                    <div class="row">
                                       ...
                                       <input name="domain_name" type="text" required class="form-control" placeholder="Enter Domain Name" value="<?php echo $row_rds['nm_domain']; ?>" data-error="Your Data is invalid">
                                       <div class="help-block form-text with-errors form-control-feedback"></div>
                                    </div>
                                       </div>
                                       ...
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                       <label for=""> Shop Name</label>
                                       <input name="shop_name" type="text" required class="form-control" placeholder="Enter Shop Name" value="<?php echo $row_rds['nm_toko']; ?>" data-error="Your Data is invalid">
                                       <div class="help-block form-text with-errors form-control-feedback"></div>
                                    </div>
                                       </div>
                                    ...
                                    <div class="row">
                                       ...
                                       <input class="form-control" data-error="Your Data is invalid" placeholder="Enter Email" required type="email" name="email" value="<?php echo $row_rds['email_toko']; ?>" >
                                       <div class="help-block form-text with-errors form-control-feedback"></div>
                                    </div>
                                       </div>
                                       ...
                                       <input name="no_hp" type="text" required class="form-control" placeholder="Enter Mobile Number" value="<?php echo $row_rds['hp_toko']; ?>" data-error="Your Data is invalid">
                                       <div class="help-block form-text with-errors form-control-feedback"></div>
                                    </div>
                                       </div>
                                    ...
                                    <div class="form-group">
                                       <label for=""> Shop Tagline</label>
                                       <input name="tagline"  type="text" class="form-control" value="<?php echo $row_rds['tagline_toko']; ?>" data-error="Your Data is invalid">
                                       <div class="help-block form-text with-errors form-control-feedback"></div>
                                    </div>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                             ...
                                             <input name="alamat_toko"  type="text" class="form-control" value="<?php echo $row_rds['alamat_toko']; ?>" data-error="Your Data is invalid">
                                          </div>
                                       </div>
                                    ...
                                    <legend><span>Data Member</span></legend>
                                    
                                    <div class="form-group">
                                       <label for=""> Home Address</label>
                                       <input name="alamat_rumah"  type="text" class="form-control" value="<?php echo $row_rmem['alamat']; ?>" data-error="Your Data is invalid">
                                       <div class="help-block form-text with-errors form-control-feedback"></div>
                                    </div>
...
?>
                                    ...
                                    <div class="row">
                                       ...
                                       <input name="wa"  type="text" class="form-control" placeholder="Enter Wa Number" value="<?php echo $row_rmem['whatsapp']; ?>" data-error="Your Data is invalid">
                                       <div class="help-block form-text with-errors form-control-feedback"></div>
                                    	</div>
                                       	</div>
                                       ...
                                       <input name="facebook" type="text" class="form-control" placeholder="Enter Facebook" value="<?php echo $row_rmem['facebook']; ?>" data-error="Your Data is invalid">
                                       <div class="help-block form-text with-errors form-control-feedback"></div>
                                    	</div>
                                       </div>
                                       ...
                                       <input name="instagram" type="text" class="form-control" placeholder="Enter Instagram" value="<?php echo $row_rmem['instagram']; ?>" data-error="Your Data is invalid">
                                       <div class="help-block form-text with-errors form-control-feedback"></div>
                                    	</div>
                                       </div>
                                       ...
                                       <input name="twitter" type="text" class="form-control" placeholder="Enter Twitter" value="<?php echo $row_rmem['twitter']; ?>" data-error="Your Data is invalid">
                                       <div class="help-block form-text with-errors form-control-feedback"></div>
                                    	</div>
                                       </div>
