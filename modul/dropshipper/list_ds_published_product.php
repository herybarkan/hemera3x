...
$query_rprod = "SELECT product_master.id_, product_master.sku, ds_product.id_ AS id_dsp, ds_product.hjual, ds_product.margin, product_master.kd_product, ds_product.hpp, product_master.nm_product, product_master.kd_warna, product_master.kd_size, product_master.deskripsi, product_master.foto_utama FROM product_master JOIN ds_product ON product_master.kd_product = ds_product.kd_product WHERE kd_ds='$_SESSION[HEM_kd_ds]'  AND hjual!='0' AND ds_product.aktif='1' AND ds_product.published='1' ORDER BY ds_product.id_ DESC";
...
<div class="element-wrapper">
   <h6 class="element-header">List of Master Published Product
   ...
   <div class="element-box-tp">
      <div class="table-responsive">
         <table width="100%" id="example" class="table table-padded">
            ...
            <tbody>
               <?php do { ?>
               <tr style="padding:10px; margin-bottom:15px;">
...
$totalRows_rsz = mysql_num_rows($rsz);
                   ...
                   <!-- <a href="javascript:void(0);" data-href="modul/product/detail_master_product.php?id_=<?php //echo $row_rprod['id_']; ?>" class="btn btn-success btn-sm text-white openPopup">Detail</a>-->
                    ...
                    <center>
                    <a href="modul/dropshipper/update_price.php?id_=<?php echo $row_rprod['id_dsp']; ?>" class="btn btn-primary btn-sm "data-target=".bd-example-modal-lg" data-toggle="modal" style="width:100px;">Update</a>
                    </center>
