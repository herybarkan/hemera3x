...
$query_rinsup = "UPDATE dropshiper SET
nm_domain='$_POST[domain_name]',
nm_toko='$_POST[shop_name]',
tagline_toko='$_POST[tagline]',
logo='$_name_',
email_toko='$_POST[email]',
hp_toko='$_POST[no_hp]',
...
header("Location: ../../index.php?com=biodata_ds&layout=full");
?>