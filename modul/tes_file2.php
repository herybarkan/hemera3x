        ...
        <td align="center" valign="top" style="background:#FFF;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td align="center" valign="top"><table width="110" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center" valign="top"><a href="#"><img src="images/logo.png" width="110" height="25" alt="" /></a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="center" valign="top"><table width="80" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="80" align="center" valign="middle"><img src="images/welcome-image.png" width="80" height="80" alt="" style="-moz-border-radius: 85px; border-radius: 85px;" /></td>
              </tr>
            </table></td>
          </tr>
          <tr>
           ...
           <tr>
            <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:22px; color:#4b4b4c; line-height:30px; font-weight:normal;">Hello! <br />
              Herybarkan</td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:48px; color:#4b4b4c; line-height:50px; font-weight:bold;">Welcome </td>
          </tr>
          <tr>
            <td align="center" valign="top">&nbsp;</td>
          </tr>
          <tr>
            <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:13px; color:#71746f; line-height:22px; font-weight:normal;">Please take a second to confirm your email address for activate your account.</td>
          </tr>
          <tr>
            <td align="center" valign="top"><table width="180" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td height="60" align="center" valign="middle" style="background:#f04386; -moz-border-radius: 40px; border-radius: 40px; font-family:'Open Sans', Verdana, Arial; font-size:14px; font-weight:bold; text-transform:uppercase; color:#FFF; "><a href="#" style="text-decoration:none; color:#FFF;">Confirm Email</a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:13px; color:#71746f; line-height:22px; font-weight:normal;">Get social with tellmail</td>
          </tr>
          <tr>
            <td align="center" valign="top">&nbsp;</td>
          </tr>
          <tr>
            <td align="center" valign="top"><table width="85" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center" valign="top"><a href="#"><img src="images/facebook.png" width="22" height="22" alt="" /></a></td>
                <td align="center" valign="top"><a href="#"><img src="images/twitter.png" width="22" height="22" alt="" /></a></td>
                <td align="center" valign="top"><a href="#"><img src="images/dribbble.png" width="22" height="22" alt="" /></a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
    ...
    <td align="center" valign="top"><table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left-inner">
      <tr>
        <td align="center" valign="top"><table width="260" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:12px; color:#4b4b4c; line-height:30px; font-weight:normal;"> &copy; 2018 tellmail.com</td>
          </tr>
          <tr>
            <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:13px; color:#4b4b4c; line-height:20px; font-weight:bold;">tellmail campus,linkten street,<br />
              king 2586,France.</td>
          </tr>
          <tr>
            <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:12px; color:#4b4b4c; line-height:30px; font-weight:bold; text-decoration:underline;">Unsubscribe</td>
          </tr>
        </table></td>
      </tr>
    </table></td>
...
<?php echo "berhasil menulis file"; ?>