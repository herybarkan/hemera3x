                        ...
                        <div class="pricing-slider-wrapper">
                            <div class="pricing-slider owl-theme owl-carousel">
                                ...
                                <div class="pricing-item-2">
                                    ...
                                    <h2 class="title">Terjadi Kesalahan</h2>
                                    <span class="info">Username <?php echo $_GET['username']; ?></span>
                                    <span class="info">Sudah Terdaftar</span>
                                    ...
                                    <a href="?com=reg_dropshipper" class="get-button">Registrasi Lagi<i class="flaticon-right"></i></a>
                                </div>
