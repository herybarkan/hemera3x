            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="coverage-right-area text-lg-right">
                        ...
                        <a href="about.html#0">Total User Reviews <i class="fas fa-paper-plane"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="team-item">
                        ...
                        <div class="team-content">
                            <h4 class="title">
                                <a href="about.html#0">Alex Love</a>
                            </h4>
                            <span class="info">Chief executive officer</span>
                            <a href="about.html#0" class="linkedin"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="team-item">
                        ...
                        <div class="team-content">
                            <h4 class="title">
                                <a href="about.html#0">Kathy Holt</a>
                            </h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-item">
                        ...
                        <div class="team-content">
                            <h4 class="title">
                                <a href="about.html#0">Steven Mann</a>
                            </h4>
     ...
     <section class="testimonial-section padding-top-2 padding-bottom-2">
        <div class="container">
            ...
            <div class="testimonial-wrapper">
                <a href="about.html#0" class="testi-next trigger">
                    <img src="assets/images/client/left.png" alt="client">
                </a>
                <a href="about.html#0" class="testi-prev trigger">
                ...
                <div class="testimonial-area testimonial-slider owl-carousel owl-theme">
                    <div class="testimonial-item">
                        ...
                        <div class="testimonial-content">
                            ...
                            <h5 class="title"><a href="about.html#0">Bela Bose</a></h5>
                        </div>
                    </div>
                    <div class="testimonial-item">
                        <div class="testimonial-thumb">
                        ...
                        <div class="testimonial-content">
                            ...
                            <h5 class="title"><a href="about.html#0">Raihan Rafuj</a></h5>
                        </div>
                    </div>
                </div>
                <div class="button-area">
                    <a href="about.html#0" class="button-2">Leave a review <i class="flaticon-right"></i></a>
                </div>
            </div>
        </div>
    </section>
