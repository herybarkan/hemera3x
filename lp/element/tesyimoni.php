<section class="testimonial-section padding-top">
        <div class="container">
            ...
            <div class="testimonial-wrapper">
                <a href="index-5.html#0" class="testi-next trigger">
                    <img src="assets/images/client/left.png" alt="client">
                </a>
                <a href="index-5.html#0" class="testi-prev trigger">
                ...
                <div class="testimonial-area testimonial-slider owl-carousel owl-theme">
                    <div class="testimonial-item">
                        ...
                        <div class="testimonial-content">
                            ...
                            <h5 class="title"><a href="index-5.html#0">Bela Bose</a></h5>
                        </div>
                    </div>
                    <div class="testimonial-item">
                        <div class="testimonial-thumb">
                        ...
                        <div class="testimonial-content">
                            ...
                            <h5 class="title"><a href="index-5.html#0">Raihan Rafuj</a></h5>
                        </div>
                    </div>
                </div>
                <div class="button-area">
                    <a href="index-5.html#0" class="button-2">Leave a review <i class="flaticon-right"></i></a>
                </div>
            </div>
        </div>
    </section>